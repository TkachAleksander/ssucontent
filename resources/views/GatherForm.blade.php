...
<?php
        ...
        switch ($form_info->name_elements){
            case 'input(text)':
                echo $group;
                echo $label;
                echo '<input type="text" class="form-control" name="'.$id_fields_forms.'" value="'.$value.'"></input>';
                echo $groupend;
                break;
            ...
            case 'input(email)':
                echo $group;
                echo $label;
                echo '<input type="email" class="form-control" name="'.$id_fields_forms.'" value="'.$value.'"></input>';
                echo $groupend;
                break;
            ...
            case 'textarea':
                echo $group;
                echo $label;
                echo '<textarea class="form-control textarea-resize-none" name="'.$id_fields_forms.'">'.$value.'</textarea>';
                echo $groupend;
                break;
            ...
            case 'checkbox':
                ...
                echo $label;
                    foreach ($id_sub_elements as $key_ise => $id_sub_element){
                        ...
                        echo '<label><input type="checkbox" name="'.$id_fields_forms.'[]" value="'.$id_sub_element.'"'.$checked.'> '.$labels_sub_elements[$key_ise].'</label><br> ';
                    }
                echo $groupend;
                break;
            ...
            case 'radiobutton':
                ...
                echo $label;
                    foreach ($id_sub_elements as $key_ise => $id_sub_element){
                        ...
                        echo '<label><input type="radio" name="'.$id_fields_forms.'[]" value="'.$id_sub_element.'"'.$checked.'> '.$labels_sub_elements[$key_ise].'</label><br> ';
                    }
                echo $groupend;
                break;
            ...
            case 'select':
                echo $group;
                echo $label.'<select name="'.$id_fields_forms.'[]" class="margin-left-10 multiselect">';
                    foreach ($id_sub_elements as $key_ise => $id_sub_element){
                        $checked = '';
                        if (isset($id_selected)){
                        foreach ($id_selected as $id_select){
